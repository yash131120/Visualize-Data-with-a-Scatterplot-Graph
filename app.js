  ...
  fetch(
    ...
    .then(function (data) {
      ...
      var timeMin = data.reduce(function (p, c) {
        return c.Seconds < p ? c.Seconds : p;
      ...
      var yAxis = d3.svg
        .axis()
        .scale(d3.scale.linear().domain([0, data.length]).range([0, height]))
        .orient("left")
        .ticks(10);
      ...
      bar
        ...
        .attr(
          "transform",
          "translate(0" + (margin.left - 10) + ", " + margin.top + 10 + ")"
        )
        .call(yAxis)
        .selectAll("line")
      ...
      bar
        ...
        .attr(
          "transform",
          "translate(0" + (margin.left - 38) + ", " + margin.top + 100 + ")"
        )
        .append("text")
      ...
      bar
        ...
        .attr(
          "transform",
          "translate(" + (margin.left - 10) + ", " + (height + 10) + ")"
        )
        .call(xAxis)
        .selectAll("line")
        .style({ stroke: "#000", "stroke-width": "0.1" })
      ...
      bar
        ...
        .attr(
          "transform",
          "translate(0" + (margin.left + 10) + ", " + height + ")"
        )
        .append("text")
        .text("Record time");
      ...
      var legend1 = bar
        ...
        .attr(
          "transform",
          "translate(0" + (margin.left + 20) + ", " + (height - 50) + ")"
        );

      legend1.append("circle").attr("r", 5).attr("fill", "#9000ff");
      ...
      var legend2 = bar
        ...
        .attr(
          "transform",
          "translate(0" + (margin.left + 20) + ", " + (height - 70) + ")"
        );

      legend2.append("circle").attr("r", 5).attr("fill", "#ff44ff");
